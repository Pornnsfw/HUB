        ...
        local ok, val = pcall(function()
            ...
            if atom then
                if type(atom.Get) == "function" then
                    local aOk, aVal = atom:Get():await()
                    if aOk and aVal ~= nil then return aVal end
                end
...
function CombinedData:GetNextTrial()
    ...
    local timeOfNextTrial = (currentRotation.expiresAt or currentTime) + 1 
